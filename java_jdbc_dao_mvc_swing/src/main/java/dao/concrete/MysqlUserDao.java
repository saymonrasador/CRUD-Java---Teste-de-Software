...
public class MysqlUserDao implements UserDao {
	...
	public User findById(Long id) throws SQLException {
        /** --- CASO RETORNAR NULL (NullPointerException) USAR ESSE CODIGO---
         *
         * DaoFactory factory = DaoFactory.getDatabase();
        if (factory == null) {
            throw new IllegalStateException("Database factory not initialized");
        }
        Connection c = factory.openConnection();
        **/
